...
- **Подробный поиск в веб-панели пользователя**: добавлена расширенная функция поиска в панели пользователя
  - Новая вкладка "Подробно" (🔍) в панели пользователя (webapp_user_search_filters)
  ...
  - Кнопки сброса и сохранения фильтров с AJAX
  ...
  - Маршруты: /webapp/user_search_filters, /webapp/user_search_filters/save, /webapp/user_search_filters/reset
